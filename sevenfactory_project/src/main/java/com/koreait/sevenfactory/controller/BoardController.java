...
import com.koreait.sevenfactory.command.noticeboard.NoticeBoardViewCommand2;
...
public class BoardController {
  ...
  //************************************************************************************//
   //review
      ...
      //관리자
      @RequestMapping("noticeBoardViewPage2")
      public String noticeBoardViewPage2(HttpServletRequest request, Model model) {
         model.addAttribute("request", request);
         command = new NoticeBoardViewCommand2();
         command.execute(sqlSession, model);
         return "noticeBoard/noticeBoardViewPage";
      }
